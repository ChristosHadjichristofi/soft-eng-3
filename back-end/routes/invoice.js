...
router.get('/costenergytotals/:ownerid/:year/:month', invoiceController.getCostenergytotals);

router.get('/chargeslist/:ownerid/:year/:month', invoiceController.getChargeslist);
